    ...
    <div className="min-h-screen text-white pb-32 overflow-x-hidden grid-bg">
              ...
              <div className="space-y-3">
                ...
                {matches.length === 0 && (
                  <div className="text-center py-16 space-y-3">
                    ...
                    <p className="section-label">暿無比賿紀�!�</p>
                  </div>
                )}
              </div>
            </motion.div>
      ...
      <Dock
        items={[
          ...
          { active: activeTab === 'teaming',     onClick: () => setActiveTab('teaming'),     icon: Users,           label: '組骊' },
          { type: 'special',                     onClick: () => setActiveTab('play'),         icon: Plus,            label: '比賽' },
          { active: activeTab === 'history',     onClick: () => setActiveTab('history'),     icon: History,         label: '紀�!�' },
